      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-10">
            <h1 className="text-2xl sm:text-3xl font-heading font-semibold text-slate-900">Hubungi Kami</h1>
            <p className="text-slate-500 mt-3 sm:mt-4 text-base sm:text-lg">Konsultasi gratis 15 menit untuk semua klien baru.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-6 sm:gap-10">
            <div className="md:col-span-2">
              {submitted ? (
                <div className="p-6 sm:p-8 bg-green-50 rounded-xl border border-green-100 text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-100 text-green-600 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </div>
                  <h2 className="text-xl font-heading font-semibold mb-2 text-green-800">Terima Kasih!</h2>
                  <p className="text-green-700">Pesan Anda telah terkirim. Tim kami akan menghubungi Anda segera.</p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl p-5 sm:p-8 shadow-card">
                  ...
                  <div className="mt-6 sm:mt-8">
                    <button
                      ...
                      className="w-full md:w-auto btn-primary flex items-center justify-center text-base"
                    >
                      {isSubmitting ? (
                        <>
              ...
              <div className="bg-white p-6 rounded-xl shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1">+62 813 1743 5622</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 mt-1">Senin - Jumat: 09:00 - 17:00<br/>Sabtu: 09:00 - 13:00</p>
                  </div>
                </div>
              </div>
            </div>
