...
import { HiSparkles, HiCheckCircle, HiShieldCheck, HiOutlineSparkles } from 'react-icons/hi';
import { FaGlobe, FaEnvelopeOpenText, FaPalette, FaBookOpen, FaArrowRight, FaWhatsapp, FaRocket, FaClock, FaHeadset, FaLayerGroup } from 'react-icons/fa';
