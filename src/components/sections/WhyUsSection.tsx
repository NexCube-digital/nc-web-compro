...
export const WhyUsSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50/50 via-white to-blue-50/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* Modern Comparison Table Container */}
        <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-slate-200/90 shadow-2xl shadow-blue-500/5 overflow-hidden">
          
          {/* Table Header */}
          <div className="grid grid-cols-12 bg-gradient-to-r from-[#126EFE] via-blue-600 to-blue-700 text-white py-5 px-6 items-center shadow-md">
            <div className="col-span-6 md:col-span-6 font-bold text-sm md:text-base flex items-center gap-2">
              <span>Fitur & Standar Kerja</span>
            </div>

            <div className="col-span-3 md:col-span-3 flex items-center justify-center gap-1.5 text-center">
              <IoMdCube className="w-4 h-4 text-[#FBA41C]" />
              <span className="font-extrabold text-sm md:text-base text-amber-300">NexCube</span>
            </div>

            <div className="col-span-3 md:col-span-3 text-center font-bold text-xs md:text-sm text-blue-100/90">
              Penyedia Lain
            </div>
          </div>
          ...
          <div className="divide-y divide-slate-100">
            {comparison.map((item, idx) => (
              <div 
                key={idx}
                className={`grid grid-cols-12 py-4.5 px-6 items-center text-xs md:text-sm transition-colors duration-200 ${
                  idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'
                } hover:bg-blue-50/40`}
              >
                {/* Feature Description */}
                <div className="col-span-6 md:col-span-6 font-bold text-slate-800 pr-2">
                ...
                <div className="col-span-3 md:col-span-3 flex justify-center">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#126EFE] to-blue-600 text-white flex items-center justify-center font-bold shadow-md shadow-blue-500/20 transform hover:scale-110 transition-transform">
                ...
                <div className="col-span-3 md:col-span-3 flex justify-center">
                  {item.other ? (
                    <div className="w-7 h-7 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center font-bold">
                      <FaCheck className="w-3 h-3" />
                    </div>
                  ) : (
                    <div className="w-7 h-7 rounded-full bg-rose-50 border border-rose-100 text-rose-400 flex items-center justify-center font-bold">
          ...
          <div className="bg-slate-50 border-t border-slate-100 py-3.5 px-6 text-center text-xs text-slate-500 font-medium">
