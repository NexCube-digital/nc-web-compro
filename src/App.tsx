              ...
              <div>
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Jl. Bukit Jarian dlm VI No. 30, Kota Bandung</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mt-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <a href="mailto:nexcubedigital@gmail.com" className="hover:text-white transition-colors">nexcubedigital@gmail.com</a>
                  </li>
                </ul>
              </div>
            </div>
